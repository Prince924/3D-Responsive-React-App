...
const Header = () => {
    ...
    return (
        <header className="flex justify-between items-center py-4 px-4 lg:px-20">
            ...
            <button onClick={toggleMonileMenu} className='md:hidden text-3xl p-2 z-50'>
                <i className='bx bx-menu'></i>
            </button>

            {/* Mobile menu - Hidden by default */}
            <div id='mobileMenu' className='hidden fixed top-16 bottom-0 right-0 left-0 p-5 md:hidden z-40 bg-black bg-opacity-70 background-blur- md'>
                <nav className='flex flex-col gap-6 items-center'>
                    <a className="text-base tracking-wider transaction-colors hover:text-gray-300 z-50" href="#">COMPANY</a>
                    <a className="text-base tracking-wider transaction-colors hover:text-gray-300 z-50" href="#">FEATURES</a>
                    <a className="text-base tracking-wider transaction-colors hover:text-gray-300 z-50" href="#">RESOURCES</a>
                    <a className="text-base tracking-wider transaction-colors hover:text-gray-300 z-50" href="#">DOCS</a>
                </nav>
            </div>
